...
@Component({
    ...
    template: `
        <div class="ionic-image-cache-prelative ionic-image-cache-container">
            <div
                *ngIf="!srcUrl && this.imageCacheConfig.spinnerEnabled"
                text-center
                class="ionic-image-cache-absolute-center ionic-image-cache-progress-div"
            >
                <ion-spinner
                    [color]="spinnerColorString"
                    [name]="spinnerNameString"
                ></ion-spinner>
            </div>
            <img
                #realImage
                *ngIf="srcUrl"
                ...
                [alt]="altString"
                class="{{ imgCssClass }}"
                (click)="presentImage($event, realImage)"
            />
